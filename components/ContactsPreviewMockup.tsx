...
import { Search, ChevronDown, Plus, Users, Star, Clock, UserPlus, Copy, Filter, ChevronLeft, ChevronRight, Phone, Mail, Calendar, Settings, HelpCircle, LayoutGrid, LayoutList } from 'lucide-react';
