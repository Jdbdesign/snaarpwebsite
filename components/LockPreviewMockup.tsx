...
import { Search, ChevronDown, Plus, Lock, Star, CreditCard, FileText, ShieldAlert, Eye, Filter, ChevronLeft, ChevronRight, Calendar, Settings, HelpCircle, KeyRound } from 'lucide-react';
