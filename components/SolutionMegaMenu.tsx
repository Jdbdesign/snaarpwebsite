...
const TABS: SolutionTab[] = [
  {
    ...
    items: [
      ...
      { title: 'Financial Operations', desc: 'Invoice, reconcile, and report without stitching tools together.', Icon: Wallet, href: '/solutions/financial-operations' },
      { title: 'Remote & Hybrid Collaboration', desc: "Meet, chat, and co-edit like your team's in the same room.", Icon: Video, href: '/solutions/remote-hybrid-collaboration' },
    ],
  },
  {
    id: 'industry',
