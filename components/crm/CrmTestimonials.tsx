...
const TESTIMONIALS = [
  {
    quote: '"We went from a shared spreadsheet to an actual pipeline in about ten minutes."',
    initials: 'RM',
    avatarBg: '#EDE9FE',
    avatarColor: '#7C3AED',
    name: 'Rowan M.',
  ...
  {
    quote: '"Emails and meetings logging themselves to the right deal is the feature I didn’t know I needed."',
    initials: 'SB',
    avatarBg: '#D5F5EF',
    avatarColor: '#0E9384',
    name: 'Sam B.',
  ...
  {
    quote: '"Simple enough that the whole team actually uses it, instead of just updating it before the Monday meeting."',
    initials: 'NK',
    avatarBg: '#FDE6C9',
    avatarColor: '#B45309',
    name: 'Nadia K.',
  ...
  return (
    <section style={{ background: '#fff', paddingTop: '92px', paddingBottom: '92px' }}>
      <CrmRevealSection className="max-w-7xl mx-auto px-6 lg:px-10">
        <div data-crm-reveal="" style={{ textAlign: 'center', maxWidth: '600px', margin: '0 auto 48px' }}>
          <span style={{ fontSize: '11.5px', fontWeight: 600, letterSpacing: '.14em', color: '#7C3AED', textTransform: 'uppercase' }}>What teams say</span>
          <h2 className="crm-faq-heading" style={{ margin: '12px 0 0', color: '#1B1730' }}>A pipeline the whole team actually uses.</h2>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '22px' }}>
          {TESTIMONIALS.map((t, i) => (
            <div
              key={t.name}
              data-crm-reveal=""
              data-crm-reveal-delay={i * 100 || undefined}
