...
const TESTIMONIALS = [
  {
    quote: '"I stopped texting myself reminders. Everything just goes in Notepad now."',
    initials: 'RM',
    avatarBg: '#EDE9FE',
    avatarColor: '#7C3AED',
    name: 'Rowan M.',
  ...
  {
    quote: '"The checklist notes replaced a sticky-note wall on my monitor."',
    initials: 'SB',
    avatarBg: '#D5F5EF',
    avatarColor: '#0E9384',
    name: 'Sam B.',
  ...
  {
    quote: '"Being able to turn a scrappy note into a real doc without retyping it is genuinely useful."',
    initials: 'NK',
    avatarBg: '#FDE6C9',
    avatarColor: '#B45309',
    name: 'Nadia K.',
...
export function NotepadTestimonials() {
  return (
    <section style={{ background: '#fff', paddingTop: '92px', paddingBottom: '92px' }}>
      <NotepadRevealSection className="max-w-7xl mx-auto px-6 lg:px-10">
        <div data-notepad-reveal="" style={{ textAlign: 'center', maxWidth: '600px', margin: '0 auto 48px' }}>
          <span style={{ fontSize: '11.5px', fontWeight: '600', letterSpacing: '.14em', color: '#7C3AED', textTransform: 'uppercase' }}>What people say</span>
          <h2 className="notepad-faq-heading" style={{ margin: '12px 0 0', color: '#1B1730' }}>The note app people actually keep open.</h2>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '22px' }}>
          {TESTIMONIALS.map((t, i) => (
            <div
              key={t.name}
              data-notepad-reveal=""
              data-notepad-reveal-delay={i * 100 || undefined}
