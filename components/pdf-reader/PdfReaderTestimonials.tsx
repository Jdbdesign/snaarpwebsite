...
const TESTIMONIALS = [
  {
    quote: '"We used to email contracts out for signature and chase people for a week. Now it\'s a link and a reminder."',
    initials: 'DL',
    avatarBg: '#EDE9FE',
    avatarColor: '#7C3AED',
    name: 'Dana L.',
  ...
  {
    quote: '"Having the PDF tool live in the same place as Mail and Drive means nobody\'s downloading, signing, and re-uploading anymore."',
    initials: 'PR',
    avatarBg: '#D5F5EF',
    avatarColor: '#0E9384',
    name: 'Priya R.',
  ...
  {
    quote: '"Simple enough that clients never ask \'how do I sign this.\'"',
    initials: 'TM',
    avatarBg: '#FDE6C9',
    avatarColor: '#B45309',
    name: 'Tom M.',
...
export function PdfReaderTestimonials() {
  return (
    <section style={{ background: '#fff', paddingTop: '92px', paddingBottom: '92px' }}>
      <PdfReaderRevealSection className="max-w-7xl mx-auto px-6 lg:px-10">
        <div data-pdf-reveal="" style={{ textAlign: 'center', maxWidth: '600px', margin: '0 auto 48px' }}>
          <span style={{ fontSize: '11.5px', fontWeight: '600', letterSpacing: '.14em', color: '#7C3AED', textTransform: 'uppercase' }}>What teams say</span>
          <h2 className="pdf-reader-faq-heading" style={{ margin: '12px 0 0', color: '#1B1730' }}>Less chasing, more signing.</h2>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '22px' }}>
          {TESTIMONIALS.map((t, i) => (
            <div
              key={t.name}
              data-pdf-reveal=""
              data-pdf-reveal-delay={i * 100 || undefined}
