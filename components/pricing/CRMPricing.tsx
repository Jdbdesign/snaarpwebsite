...
const PLANS: Plan[] = [
  {
    name: 'Starter', slug: 'starter', monthlyPrice: 8,
    storageLabel: '1,000 contacts', segment: 'Small teams', popular: false,
    addonsIcons: [
    ...
    features: ['1,000 contacts', 'Pipeline board', 'Deal tracking', 'Activity log', 'Email integration', 'Mobile app'],
  },
  {
    name: 'Professional', slug: 'professional', monthlyPrice: 29,
    storageLabel: '25,000 contacts', segment: 'Growing sales teams', popular: true,
    addonsIcons: [
      { src: '/assets/icons/search.jpg', name: 'Contacts' },
      { src: '/assets/icons/envelope.jpg', name: 'Mail' },
      { src: '/assets/icons/logos/snaarpme.svg', name: 'SnaarpMe' },
    ...
    features: ['25,000 contacts', 'Multiple pipelines', 'Deal tracking', 'Activity log', 'Email integration', 'Automation workflows', 'Reporting dashboard', 'Custom fields'],
  },
  {
    name: 'Enterprise', slug: 'enterprise', monthlyPrice: 59,
    storageLabel: 'Unlimited contacts', segment: 'Large organisations', popular: false,
    addonsIcons: [
      { src: '/assets/icons/search.jpg', name: 'Contacts' },
      { src: '/assets/icons/envelope.jpg', name: 'Mail' },
      { src: '/assets/icons/logos/snaarpme.svg', name: 'SnaarpMe' },
    ...
    features: ['Unlimited contacts', 'Unlimited pipelines', 'Deal tracking', 'Activity log', 'Email integration', 'Advanced automation', 'Custom reporting', 'Custom fields', 'Revenue forecasting', 'API access'],
  },
];
...
const COMPARE: CompareCategory[] = [
  { name: 'Core', rows: [
    { label: 'Contacts', cells: [text('1,000'), text('25,000'), text('Unlimited')] },
    { label: 'Pipelines', cells: [text('1'), text('Multiple'), text('Unlimited')] },
    { label: 'Deal tracking', cells: [check, check, check] },
    { label: 'Activity log', cells: [check, check, check] },
  ]},
  { name: 'Sales Tools', rows: [
    { label: 'Email integration', cells: [check, check, check] },
    { label: 'Automation workflows', cells: [cross, check, check] },
    { label: 'Advanced automation', cells: [cross, cross, check] },
    { label: 'Custom fields', cells: [cross, check, check] },
    { label: 'Revenue forecasting', cells: [cross, cross, check] },
  ]},
  { name: 'Reporting', rows: [
    { label: 'Basic reports', cells: [check, check, check] },
    { label: 'Reporting dashboard', cells: [cross, check, check] },
    { label: 'Custom reporting', cells: [cross, cross, check] },
    { label: 'Export data', cells: [check, check, check] },
  ]},
  { name: 'Support', rows: [
...
export function CRMPricing({ billingCycle = 'monthly' }: { billingCycle?: 'monthly' | 'yearly' }) {
