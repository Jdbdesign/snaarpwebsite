...
const PLANS: Plan[] = [
  {
    name: 'Starter', slug: 'starter', monthlyPrice: 9, storageLabel: '500 leads/mo', segment: 'Solo prospectors', popular: false,
    addonsIcons: [
    ...
    features: ['500 leads per month', 'Email finder', 'Basic filters', 'CSV export', 'Chrome extension'],
  },
  {
    name: 'Growth', slug: 'growth', monthlyPrice: 29, storageLabel: '3,000 leads/mo', segment: 'Sales teams', popular: true,
    addonsIcons: [
      { src: '/assets/icons/search.jpg', name: 'Contacts' },
      { src: '/assets/icons/envelope.jpg', name: 'Mail' },
      { src: '/assets/icons/apps-sendrit.jpg', name: 'Sendrit' },
    ...
    features: ['3,000 leads per month', 'Email & phone finder', 'Advanced filters', 'CSV export', 'Chrome extension', 'Enrichment', 'Sequence integration', 'Team sharing'],
  },
  {
    name: 'Scale', slug: 'scale', monthlyPrice: 69, storageLabel: '15,000 leads/mo', segment: 'Agencies & enterprises', popular: false,
    addonsIcons: [
      { src: '/assets/icons/search.jpg', name: 'Contacts' },
      { src: '/assets/icons/envelope.jpg', name: 'Mail' },
      { src: '/assets/icons/apps-sendrit.jpg', name: 'Sendrit' },
    ...
    features: ['15,000 leads per month', 'Email & phone finder', 'Advanced filters', 'CSV export', 'Chrome extension', 'Enrichment', 'Sequence integration', 'Team sharing', 'API access', 'Dedicated support'],
  },
];
...
const COMPARE: CompareCategory[] = [
  { name: 'Core', rows: [
    { label: 'Leads per month', cells: [text('500'), text('3,000'), text('15,000')] },
    { label: 'Email finder', cells: [check, check, check] },
    { label: 'Phone finder', cells: [cross, check, check] },
    { label: 'Chrome extension', cells: [check, check, check] },
  ]},
  { name: 'Prospecting', rows: [
    { label: 'Basic filters', cells: [check, check, check] },
    { label: 'Advanced filters', cells: [cross, check, check] },
    { label: 'Enrichment', cells: [cross, check, check] },
    { label: 'Company data', cells: [cross, check, check] },
    { label: 'Intent signals', cells: [cross, cross, check] },
  ]},
  { name: 'Integrations', rows: [
    { label: 'CSV export', cells: [check, check, check] },
    { label: 'Sequence integration', cells: [cross, check, check] },
    { label: 'CRM sync', cells: [cross, check, check] },
...
export function NeoLeadsPricing({ billingCycle = 'monthly' }: { billingCycle?: 'monthly' | 'yearly' }) {
