...
const PLANS: Plan[] = [
  {
    ...
    features: ['1,000 emails per month', 'Drag-and-drop editor', 'Basic templates', 'Delivery analytics', 'Unsubscribe management'],
  },
  {
    name: 'Growth',
    slug: 'growth',
    monthlyPrice: 19,
    storageLabel: '10,000 emails/mo',
    segment: 'Growing teams & SMEs',
    popular: true,
    addonsIcons: [
      { src: '/assets/icons/apps-sendrit.jpg', name: 'Sendrit' },
      { src: '/assets/icons/envelope.jpg', name: 'Mail' },
    ...
    features: ['10,000 emails per month', 'Drag-and-drop editor', 'Premium templates', 'A/B testing', 'Delivery analytics', 'Automation sequences', 'Segmentation', 'Custom sender domains'],
  },
  {
    name: 'Scale',
    slug: 'scale',
    monthlyPrice: 49,
    storageLabel: '100,000 emails/mo',
    ...
    features: ['100,000 emails per month', 'Drag-and-drop editor', 'Premium templates', 'A/B testing', 'Delivery analytics', 'Automation sequences', 'Advanced segmentation', 'Custom sender domains', 'Dedicated IP', 'Priority delivery'],
  },
];
...
const COMPARE: CompareCategory[] = [
  { name: 'Core', rows: [
    { label: 'Emails per month', cells: [text('1,000'), text('10,000'), text('100,000')] },
    { label: 'Contacts', cells: [text('500'), text('5,000'), text('Unlimited')] },
    { label: 'Drag-and-drop editor', cells: [check, check, check] },
    { label: 'Templates', cells: [text('Basic'), text('Premium'), text('Premium')] },
  ]},
  { name: 'Campaigns', rows: [
    { label: 'A/B testing', cells: [cross, check, check] },
    { label: 'Automation sequences', cells: [cross, check, check] },
    { label: 'Segmentation', cells: [cross, check, check] },
    { label: 'Advanced segmentation', cells: [cross, cross, check] },
    { label: 'Custom sender domains', cells: [cross, check, check] },
  ]},
  { name: 'Deliverability', rows: [
    { label: 'Delivery analytics', cells: [check, check, check] },
    { label: 'Bounce handling', cells: [check, check, check] },
    { label: 'Dedicated IP', cells: [cross, cross, check] },
    { label: 'Priority delivery', cells: [cross, cross, check] },
  ]},
  { name: 'Support', rows: [
...
export function SendritPricing({ billingCycle = 'monthly' }: { billingCycle?: 'monthly' | 'yearly' }) {
