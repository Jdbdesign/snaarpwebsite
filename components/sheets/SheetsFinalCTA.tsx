...
export function SheetsFinalCTA() {
  return (
    <section className="max-w-7xl mx-auto px-6 lg:px-10" style={{ background: "#fff", paddingTop: "40px", paddingBottom: "96px" }}>
      <SheetsRevealSection reveal style={{ background: "linear-gradient(135deg,#7C3AED,#6D28D9)", borderRadius: "28px", padding: "70px 40px", textAlign: "center", position: "relative", overflow: "hidden", boxShadow: "0 34px 70px -30px rgba(124,58,237,.6)" }}>
        ...
        <h2 className="sheets-final-cta-heading" style={{ position: "relative", color: "#fff", margin: "16px auto 0", maxWidth: "640px" }}>Spreadsheets connected to real data. <Price amount={1} /> to start.</h2>
